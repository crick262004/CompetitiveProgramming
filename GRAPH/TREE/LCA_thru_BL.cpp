...
// If qn involves thinking about the path bw 2 nodes in a tree, its built on LCA. 
// Root the Tree at a node, find the LCA of node a and node b. Now we know the path from a to b.

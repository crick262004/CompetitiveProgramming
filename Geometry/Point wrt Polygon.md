    ...
    if((p2 - p1 )* (p4 - p3) == 0){
        *// line segments are parallel*
        if(p1.triangle(p2, p3) != 0){
            ...
            *// now need to check bounding boxes.*
...
void test_case(){
    ...
    for(int i = 0; i<m; i++){
        *P* p; p.read();
        *// check if this point p is inside polygon*
 ...
 </span>![C4BEE5F7-6902-4D71-BA63-6E41DAF13A47](images/C4BEE5F7-6902-4D71-BA63-6E41DAF13A47.png)

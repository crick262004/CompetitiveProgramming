...
* **How it works:**
	1. DFS Light Child $\to$ Add data $\to$ Answer Queries $\to$ **Clear Data (Rollback)**.
...
* **How it works:**
	1. structure* my_ds = heavy_child->ds; (Swap pointer, O(1))
...
![7022C48E-4EB6-4603-B338-7A13705AA0F1](images/7022C48E-4EB6-4603-B338-7A13705AA0F1.png)
